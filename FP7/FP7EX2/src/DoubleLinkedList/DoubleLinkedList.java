...
public abstract class DoubleLinkedList<T> implements ListADT<T>, Iterable<T>{
    ...
    public String toString() {
        return printListRecursiveToHead(head);
    }  
    
    public String toStringReversed() {
        return printListRecursiveToRear(tail);
    }
    
    private String printListRecursiveToHead(DoubleNode<T> current) {
        String txt = "";
        
        if (current.getNext() == null) {
            return txt += "\n" + current.toString();
        } else {
            return txt += "\n" + current.toString() + printListRecursiveToHead(current.getNext());
        }
    }
    
    private String printListRecursiveToRear(DoubleNode<T> current) {
        String txt = "";
        
        if (current.getPrevious() == null) {
            return txt += "\n" + current.toString();
        } else {
            return txt += "\n" + current.toString() + printListRecursiveToRear(current.getPrevious());
        }
    }
